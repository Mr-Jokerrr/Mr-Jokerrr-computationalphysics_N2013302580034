...
def myA(t,mA,mB,x,n,a,b):
	...
	for i in range(len(t)):
		...
		p.append(mA)
		q.append(mB)
		mA=mA_temp+((mB_temp/b)-(mA_temp/a))*x/n
...
def main(mA0,mB0,n,x,a,b):
	...
	plt.title('$Problem1.5$',fontsize=28)
	plt.xlabel('$t$',fontsize=20)
	plt.ylabel('$N$',fontsize=20)
	plt.show()

main(3.5,3.5,100000,10.0,10,3)  #set mA0,mB0 and accuracy(the bigger the more accurate) and length of xAxis and the parameter of a,b
