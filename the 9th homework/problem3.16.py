...
plt.text(2.5,0.55,u'$\u03C9$ versus $\u03B8$   Fd=1.2',color='black',ha='center',fontsize=20)
plt.text(2.5,0.45,u'$\u03C9$D=0.45   in-phase',color='black',ha='center',fontsize=20)
plt.title('$Problem3.16$',fontsize=28)
